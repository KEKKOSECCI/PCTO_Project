<template>
    <ImgCube :type="'tv'" class="img-Cube"/>
    <div class="superContainer">
        <!-- Carica solo i generi visibili inizialmente e quelli caricati tramite scroll -->
        <NewCarousel v-for="genere in loadedGenres" :key="genere.id" :idGenere="genere.id" :type="'tv'" />
...
export default {
    ...
    data() {
        return {
            arrayGenere: dataStore.generiSerie,   // Tutti i generi disponibili
